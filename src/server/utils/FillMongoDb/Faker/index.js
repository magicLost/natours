...
var create = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, users, usersIds, guidesIds, _b, tours, toursIds, reviews;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, user_1.createUsers(50)];
            case 1:
                _a = _c.sent(), users = _a.users, usersIds = _a.usersIds, guidesIds = _a.guidesIds;
                _b = tour_1.createTours(20, guidesIds), tours = _b.tours, toursIds = _b.toursIds;
                ...
                util_1.promisify(fs_1.writeFile)(path_1.join(__dirname, "data", "reviews.js"), JSON.stringify(reviews));
                return [2 /*return*/];
        }
    });
}); };
