import { model, Types, Document, Model, Query, Schema } from "mongoose";
import TourModel, { ISchemaRef } from "./../Tour/Tour.model";

export interface IReviewModel extends Document {
  review: string;
  rating: number;
  createdAt: Date;
  tour: ISchemaRef | string;
  user: ISchemaRef | string;
}
